...
export const metadata: Metadata = {
  ...
  description: "CCC 한국대학생선교회 부산지구 개인정보처리방침",
};
        ...
        <div className="prose prose-slate max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              CCC 한국대학생선교회 부산지구(이하 &#39;회사&#39;라고 함)는 회사가
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              ...
              <li>선택 수집 정보: 2개 이상 기기 사용시 추가 기기정보</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              이용기간&quot;에 명시된 바에 따라 처리하고 그 외의 용도로 열람
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              ...
              <li>
                ...
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                  ...
                  <li>
                    다. 개인정보를 이전받는 자의 성명(법인인 경우 그 명칭 및
                    정보관리 책임자의 연락처를 말한다)
                  </li>
                  <li>
                    라. 개인정보를 이전받는 자의 개인정보 이용목적 및 보유ㆍ이용
                    기간
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <div className="ml-6 mt-2">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>성명: 배진일</li>
                    <li>직책: PM</li>
                    <li>전화번호: 010-5205-8769</li>
                    <li>이메일: varietyjin@naver.com</li>
                  </ul>
                </div>
              </li>
              <li>
              ...
              <li>
                ...
                <div className="ml-6 mt-2">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>담당부서: 개발팀</li>
                    <li>담당자명: 김정원</li>
                    <li>전화번호: 010-8322-2489</li>
                    <li>이메일: mike03131313@gmail.com</li>
                  </ul>
                </div>
              </li>
            </ol>
